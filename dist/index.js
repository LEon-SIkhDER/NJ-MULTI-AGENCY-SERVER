 ...
 */
const deleteCloudinaryImages = (publicIds) => {
    ...
    Promise.allSettled(validIds.map((publicId) => cloudinary_1.v2.uploader.destroy(publicId)))
        .then((results) => {
 ...
 */
const extractAndCleanCloudinaryPublicIds = (doc) => {
    if (!doc)
        return;
    const ids = [];
    ...
    if (ids.length > 0) {
        (0, exports.deleteCloudinaryImages)(ids);
    }
};
...
function getCollection(name) {
    return new Proxy({}, {
        get(_target, prop, receiver) {
            ...
            const col = cachedClient.db("Nj_Multi_Agency").collection(name);
...
app.delete("/pitcher/:uid", exports.verifyFBToken, async (req, res) => {
    ...
    if (pitcher) {
        (0, exports.extractAndCleanCloudinaryPublicIds)(pitcher);
    }
...
app.delete("/moderator/:uid", exports.verifyFBToken, async (req, res) => {
    ...
    if (moderator) {
        (0, exports.extractAndCleanCloudinaryPublicIds)(moderator);
    }
    await usersCollection.updateOne(uid, { $set: { role: "user" } });
...
Object.assign(app, {
    getClient,
    deleteCloudinaryImages: exports.deleteCloudinaryImages,
    extractAndCleanCloudinaryPublicIds: exports.extractAndCleanCloudinaryPublicIds,
    verifyFBToken: exports.verifyFBToken
});
exports.default = app;
module.exports = app;
